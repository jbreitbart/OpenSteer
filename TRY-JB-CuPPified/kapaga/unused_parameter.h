 ...
 */
#define KAPAGA_UNUSED_PARAMETER(expr) (void)sizeof(expr)


/**
 * Macro to surpress warning that a variable isn't used.
 */
#define KAPAGA_UNUSED_VARIABLE(expr) (void)sizeof(expr)


/**
 * Macro to surpress warning that a return value of a function isn't used.
 *
 * @attention Removed the macro because whole function calls get optimized away with it.
 */
// #define KAPAGA_UNUSED_RETURN_VALUE(expr) (void)sizeof(expr)
 ...
 * @todo Read C++ grammar and rename macro appropriate.
 */
/* #define KAPAGA_UNUSED_EXPRESSION_VALUE(expr) (void)sizeof(expr) */
