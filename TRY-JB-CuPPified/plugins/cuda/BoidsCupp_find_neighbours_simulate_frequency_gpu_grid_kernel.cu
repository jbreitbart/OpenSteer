...
__global__ void find_neighbours_simulate_fr_gpu_gr (const int                              start,
                                                const ds::deviceT::gpu_grid           &grid_,
                                                      ...
                                                      cupp::deviceT::vector< Vec3 >   &steering_results_)
{
	...
	__shared__ ds::deviceT::gpu_grid grid;
	grid = grid_;
...
simulate_frequency_gpu_grid_kernelT get_find_neighbours_simulate_frequency_gpu_grid_kernel() {
	return (simulate_frequency_gpu_grid_kernelT)find_neighbours_simulate_fr_gpu_gr;
}
