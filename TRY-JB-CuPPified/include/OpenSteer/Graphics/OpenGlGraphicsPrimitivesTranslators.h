...
namespace OpenSteer {
    ...
    public:
		...
		class BoxOpenGlGraphicsPrimitiveToRendererTranslator : public OpenGlGraphicsPrimitiveToRendererTranslator {
		public:
			virtual ~BoxOpenGlGraphicsPrimitiveToRendererTranslator();
			
			virtual bool translates( GraphicsPrimitive const* _primitive ) const;            
			/**
			 * If @a _primitive is not of type @c BoxOpenGlGraphicsPrimitiveToRendererTranslator 
			 * a @c std::bad_cast is thrown.
			 */
			virtual bool addToLibrary( GraphicsPrimitive const& _primitive, OpenGlRenderer& _renderer, InstanceContainer& _instances ) const;
		...
		}; // class BoxOpenGlGraphicsPrimitiveToRendererTranslator
		
		
		class SphereOpenGlGraphicsPrimitiveToRendererTranslator : public OpenGlGraphicsPrimitiveToRendererTranslator {
		public:
			virtual ~SphereOpenGlGraphicsPrimitiveToRendererTranslator();
			
			virtual bool translates( GraphicsPrimitive const* _primitive ) const;            
			/**
			 * If @a _primitive is not of type @c SphereOpenGlGraphicsPrimitiveToRendererTranslator 
			 * a @c std::bad_cast is thrown.
			 */
			virtual bool addToLibrary( GraphicsPrimitive const& _primitive, OpenGlRenderer& _renderer, InstanceContainer& _instances ) const;
		...
		}; // class SphereOpenGlGraphicsPrimitiveToRendererTranslator	
