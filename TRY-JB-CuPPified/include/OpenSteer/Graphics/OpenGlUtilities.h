...
namespace OpenSteer {
    ...
    namespace Graphics {
        ...
        template< size_t LineCount >
			...
			/**
			 * Creates an @c OpenGlRenderMesh that represents a box of extents
			 * @a width, @a height, and @a depth.
			 *
			 */
			SharedPointer< OpenGlRenderMesh > createBox( float width, 
														 float height, 
														 float depth, 
														 Color const& color );
			...
			/**
			 * Createss an @c OpenGlRenderMesh that represents a box of extents
			 * @a width, @a height, and @a depth.
			 */ 
			SharedPointer< OpenGlRenderMesh > createSphere( float radius, 
															size_t const slices,
															size_t const stacks,  
															Color const& color );
