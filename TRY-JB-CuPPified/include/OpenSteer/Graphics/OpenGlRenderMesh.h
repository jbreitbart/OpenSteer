...
namespace OpenSteer {
    ...
    namespace Graphics {
        ...
        struct OpenGlRenderMesh {
			...
			enum PolygonMode { POINT = GL_POINT,
							   LINE = GL_LINE,
							   FILL = GL_FILL };
            ...
            explicit OpenGlRenderMesh( Type _type, size_type _meshVertexIndexCount = 0, PolygonMode _polygonMode = FILL, TextureFunction _textureFunction = REPLACE ) 
                : vertices_( 0 ), 
                colors_( 0 ), 
                normals_( 0 ), 
