...
extern "C" { typedef void (*kernelT)(cupp::deviceT::memory1d< int, cupp::memory1d< int> >  &); }
# 18
extern "C" kernelT get_kernel(); 
#define __include___device_stub__Z15global_functionRN4cupp7deviceT8memory1dIiNS_8memory1dIiEEEE 1
#include "kernel_memory1d.cudafe1.stub.h"
#undef __include___device_stub__Z15global_functionRN4cupp7deviceT8memory1dIiNS_8memory1dIiEEEE
# 14 "/home/jbreitbart/projekte/opensteer/svn/branches/TRY-JB-CuPPified/cupp/examples/memory1d/kernel_memory1d.cu"
kernelT get_kernel() { 
# 15
return (kernelT)__device_stub__Z15global_functionRN4cupp7deviceT8memory1dIiNS_8memory1dIiEEEE; 
# 16
} 
