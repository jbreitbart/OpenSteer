...
OpenSteer::Graphics::BoxOpenGlGraphicsPrimitiveToRendererTranslator::~BoxOpenGlGraphicsPrimitiveToRendererTranslator()
{
    // Nothing to do.
}

bool 
OpenSteer::Graphics::BoxOpenGlGraphicsPrimitiveToRendererTranslator::translates( GraphicsPrimitive const* _primitive ) const
{
    return 0 != dynamic_cast< BoxGraphicsPrimitive const* >( _primitive );
}


bool 
OpenSteer::Graphics::BoxOpenGlGraphicsPrimitiveToRendererTranslator::addToLibrary( GraphicsPrimitive const& _primitive, 
																					OpenGlRenderer& _renderer, 
																					InstanceContainer& _instances ) const
{
    assert( translates( &_primitive ) && "Translator called for wrong graphics primitive." );
    
    BoxGraphicsPrimitive const& boxPrimitive = dynamic_cast< BoxGraphicsPrimitive const& >( _primitive );
    
    InstanceId id = 0;
    bool const added = _renderer.addToRenderMeshLibrary( createBox( boxPrimitive.width(),
																	boxPrimitive.height(),
																	boxPrimitive.depth(),
																	boxPrimitive.material() ),
                                                         id );
...
void 
OpenSteer::Graphics::BoxOpenGlGraphicsPrimitiveToRendererTranslator::translate( GraphicsPrimitive const& _primitive, 
																				OpenGlRenderer& _renderer ) const
{
    assert( translates( &_primitive ) && "Translator called for wrong graphics primitive." );
    ...
    _renderer.addToRender( createBox( boxPrimitive.width(),
									  boxPrimitive.height(),
									  boxPrimitive.depth(),
									  boxPrimitive.material() ) );
}
...
void 
OpenSteer::Graphics::BoxOpenGlGraphicsPrimitiveToRendererTranslator::translate( Matrix const& _transformation,
																				GraphicsPrimitive const& _primitive, 
																				OpenGlRenderer& _renderer ) const
{
    assert( translates( &_primitive ) && "Translator called for wrong graphics primitive." );
...
OpenSteer::Graphics::SphereOpenGlGraphicsPrimitiveToRendererTranslator::~SphereOpenGlGraphicsPrimitiveToRendererTranslator()
{
    // Nothing to do.
}

bool 
OpenSteer::Graphics::SphereOpenGlGraphicsPrimitiveToRendererTranslator::translates( GraphicsPrimitive const* _primitive ) const
{
    return 0 != dynamic_cast< SphereGraphicsPrimitive const* >( _primitive );
}


bool 
OpenSteer::Graphics::SphereOpenGlGraphicsPrimitiveToRendererTranslator::addToLibrary( GraphicsPrimitive const& _primitive, 
																				   OpenGlRenderer& _renderer, 
																				   InstanceContainer& _instances ) const
{
    assert( translates( &_primitive ) && "Translator called for wrong graphics primitive." );
    
    SphereGraphicsPrimitive const& spherePrimitive = dynamic_cast< SphereGraphicsPrimitive const& >( _primitive );
    
    InstanceId id = 0;
    bool const added = _renderer.addToRenderMeshLibrary( createSphere( spherePrimitive.radius(),
																	   spherePrimitive.sliceCount(),
																	   spherePrimitive.stackCount(),
																	   spherePrimitive.material() ),
														 id );
...
void 
OpenSteer::Graphics::SphereOpenGlGraphicsPrimitiveToRendererTranslator::translate( GraphicsPrimitive const& _primitive, 
																				OpenGlRenderer& _renderer ) const
{
    assert( translates( &_primitive ) && "Translator called for wrong graphics primitive." );
    ...
    _renderer.addToRender( createSphere( spherePrimitive.radius(),
										 spherePrimitive.sliceCount(),
										 spherePrimitive.stackCount(),
										 spherePrimitive.material() ) );
}
...
void 
OpenSteer::Graphics::SphereOpenGlGraphicsPrimitiveToRendererTranslator::translate( Matrix const& _transformation,
																				GraphicsPrimitive const& _primitive, 
																				OpenGlRenderer& _renderer ) const
{
    assert( translates( &_primitive ) && "Translator called for wrong graphics primitive." );
	...
	_renderer.addToRender( _transformation,
						   createSphere( spherePrimitive.radius(),
										 spherePrimitive.sliceCount(),
										 spherePrimitive.stackCount(),
										 spherePrimitive.material() ) );
}
